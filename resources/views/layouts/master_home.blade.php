    ...
    <header class="box">
        <div class="header-content">
            ...
            <a href="{{url('/')}}" class='logo-container'>
                <img src="{{asset('images/app/logo.png')}}" alt="" style="height: 57px;">
            </a>
            <!-- SEARCH -->
            <div class='search'>
            ...
            <div  id='user-actions-id' class='user-actions'>
                ...
                <a class='my-link first-icon' href="{{url('/')}}">
                    @if (Request::is('/'))
                    <svg aria-label="Home" class="_8-yf5 " fill="#349713" height="22" viewBox="0 0 48 48" width="22">
                ...
                <!-- <a href="#">
                    <svg aria-label="Find People" class="_8-yf5 " fill="#349713" height="22" viewBox="0 0 48 48" width="22">
                ...
                <div class="profile-icon">
                    <a class='clickable'>
                        <img src="{{asset('images/app/profile.jpeg')}}" alt="Profile user image">
                    ...
                    <span class="hide user-pages-links">
                        ...
                        <a href="{{url('/user/'.Auth::user()->username)}}">
                            <svg aria-label="Profile" class="_8-yf5 " fill="#349713" height="16" viewBox="0 0 32 32" width="16">
                        ...
                        <a href="{{url(Auth::user()->username.'/saved')}}">
                            <svg aria-label="Saved" class="_8-yf5 " fill="#349713" height="16" viewBox="0 0 32 32" width="16">
                        ...
                        <a href="{{url('/accounts/edit')}}">
                            <svg aria-label="Settings" class="_8-yf5 " fill="#349713" height="16" viewBox="0 0 32 32" width="16">
